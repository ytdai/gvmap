...
#' [param] integers, then dendrogram is computed and reordered based on the order of the vector.
...
#' and columns. Defaults to dist. SEE \link[gplots]{heatmap.2}
...
#' [param] bg_col background color theme, other user-define color theme must be like bg_my_theme.
